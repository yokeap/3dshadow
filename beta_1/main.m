...
%plot3(centroidLineLeft(:,1), centroidLineLeft(:,2), centroidLineLeft(:,3), '.', 'LineWidth', 1);
%hold off;
...
for i = 1:size(sampleRefPointCloud)
...
plot3(centroidLineWorld(:,1), centroidLineWorld(:,2), centroidLineWorld(:,3), '.', 'LineWidth', 1);

[shadowLength, sliceNumber] = calShadowLength(centroidLine, binSegmentShadowImage, virLightPosIMG, 1000);

% %prepare data to 
% 
% ptCloud = [sampleRefPointCloud ];