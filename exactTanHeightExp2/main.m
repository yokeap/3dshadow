...
%%%%%%    
% scalar = 200;
% sVect = s200(200,:) + uVectU(200,1:3) * scalar;
% cVect = c200(200,:) + centroidVectU(200,1:3) * scalar;
% rotVect = calRotateYAxis(centroidVectU(200,1:3), 60 * -1);
% rVect = c200(200,:) + rotVect' * scalar;
% intersectPoint = rayintersect(c200(200,:), s200(200,:), rotVect', uVectU(200,:));
% plot3([s200(200,1) sVect(1)], [s200(200,2) sVect(2)], [s200(200,3) sVect(3)], '*-', 'LineWidth', 1);
% grid on;
% plot3([c200(200,1) cVect(1)], [c200(200,2) cVect(2)], [c200(200,3) cVect(3)], '*-', 'LineWidth', 1);
% plot3([c200(200,1) rVect(1)], [c200(200,2) rVect(2)], [c200(200,3) rVect(3)], '*-', 'LineWidth', 1);
% xlabel('X');
% ylabel('Y');
% zlabel('Z');
%plot3([c200(200,1) intersectPoint(1)], [c200(200,2) intersectPoint(2)], [c200(200,3) intersectPoint(3)], '*-', 'LineWidth', 1);
%%%%%%%
