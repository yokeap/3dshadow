function [realHeight, sliceNumber] = calHeightFromShadowRay(homographyMatrix, centroidLine, binSegmentShadowImage, virLightPosIMG, virLightPos, interpolateScalar)
n=1;
k=1;
    for i=1:size(centroidLine,1)
        ...
        centroidLine2LightUVect = unitVector2D(double(centroidLine(317,1:2)), virLightPosIMG(1:2)); 
        flag = 0;
        flagFoundSomeEdge = 0;
...
%            plot3([Pt0(1) Pt1(1)], [Pt0(2) Pt1(2)], [0 0], '*-', 'LineWidth', 1); 
           ...
           if(k>10)    
            ...
            plot3([Pt0(1) Pt0(1)],[Pt0(2) Pt0(2)],[0 realHeight(n,1)], 'o-', 'LineWidth', 1);
            k=0;
           end
        end
        n = n + 1;
