function [shadowLength, sliceNumber] = calHeightFromShadow(homographyMatrix, centroidLine, binSegmentShadowImage, virLightPos, interpolateScalar)
n=1;
    for i=1:size(centroidLine,1)
        ...
        if(flagFoundSomeEdge)
           shadowLength(n,2) = sqrt((Pt0(1) * Pt0(1)) + (Pt1(2) * Pt1(2)));
